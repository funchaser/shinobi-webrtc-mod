...
module.exports = (s,config,lang) => {
    ...
    const createSnapshot = (options) => {
        ...
        return new Promise((resolve,reject) => {
            ...
            const ffmpegCmd = splitForFFPMEG(`-loglevel warning -re -probesize 100000 -analyzeduration 100000 ${inputOptions.join(' ')} -i "${url}" ${outputOptions.join(' ')} -f image2 -an -frames:v 1 "${temporaryImageFile}"`)
